...
Light::Light(std::shared_ptr<Shader> shader) : shader_{shader}
{
}

Light::Light(std::shared_ptr<Shader> shader, const Vector3& colour,
             float intensity)
    : colour_{colour}, intensity_{intensity}, shader_{shader}
{
}
